...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	LCD_Init(40,2);
	LCD_CursorSet(0,0);
	LCD_Putsxy(0, 0,"====> MUTANT 3.0 <====");
	LCD_Putsxy(0, 1,"   ==> SV UNDIP <==");
	DWT_Delayms(1000);
	LCD_Clear();
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, LIM1_Pin|LIM2_Pin|LIM3_Pin|LIM4_Pin
                          |LIM5_Pin|LIM6_Pin|LIM7_Pin|LIM8_Pin
                          |RL1_Pin|RL0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BUZZER_GPIO_Port, BUZZER_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RL7_Pin|RL6_Pin|RL5_Pin|RL4_Pin
                          |RL3_Pin|RL2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LIM1_Pin LIM2_Pin LIM3_Pin LIM4_Pin
                           LIM5_Pin LIM6_Pin LIM7_Pin LIM8_Pin
                           RL1_Pin RL0_Pin */
  GPIO_InitStruct.Pin = LIM1_Pin|LIM2_Pin|LIM3_Pin|LIM4_Pin
                          |LIM5_Pin|LIM6_Pin|LIM7_Pin|LIM8_Pin
                          |RL1_Pin|RL0_Pin;
  ...
  /*Configure GPIO pins : BT9_Pin BT8_Pin BT7_Pin BT6_Pin
                           BT5_Pin */
  GPIO_InitStruct.Pin = BT9_Pin|BT8_Pin|BT7_Pin|BT6_Pin
                          |BT5_Pin;
  ...
  /*Configure GPIO pins : RL7_Pin RL6_Pin RL5_Pin RL4_Pin
                           RL3_Pin RL2_Pin */
  GPIO_InitStruct.Pin = RL7_Pin|RL6_Pin|RL5_Pin|RL4_Pin
                          |RL3_Pin|RL2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
