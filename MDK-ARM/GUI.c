...
void inMaintananceFunction(void){
	...
	if(!buttonPress(BUTTON_PROG_PORT, BUTTON_PROG_PIN, 500)){
		...
		while(1){
//			LCD_Clear();
			LCD_Putsxy(0,0, "TROUBLE 3 MAINTENANCE");
...
void silentFunction(void){
	//while(sensor == 1){
	if(flagSensorActive[0] || flagSensorActive[1] || flagSensorActive[2] || flagSensorActive[3] || flagSensorActive[4] || flagSensorActive[5] || flagSensorActive[6] || flagSensorActive[7]){
...
// check the used zone
			for(int i = 0; i < 8; i++){
				if(strlen(i == 0 ? temp1 : i == 1 ? temp2 : i == 2 ? temp3 : i == 3 ? temp4 : i == 4 ? temp5 : i == 5 ? temp6 : i == 6 ? temp7 : temp8) > 1 ) /* ? temp8 : i == 8 ? temp9 : i == 9 ? temp10 : i == 10 ? temp11 : i == 11 ? temp12 : i == 12 ? temp13 : i == 13 ? temp14 : i == 14 ? temp15 : temp16) > 1)*/
					{
						count++;
						// zoneUse[i] = i + 1;
						zoneUse[i] = 1;					// 1 => Used
...
void checkButton(){
//	if(!buttonPress(BUTTON_TEST_PORT, BUTTON_TEST_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"TEST  ");		
//	}
//	if(!buttonPress(BUTTON_MUTE_PORT, BUTTON_MUTE_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"MUTE  ");		
//	}
//	if(!buttonPress(BUTTON_RESET_PORT, BUTTON_RESET_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"RESET ");		
//	}
//	if(!buttonPress(BUTTON_SILENT_PORT, BUTTON_SILENT_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"SILENT");		
//	}
//	if(!buttonPress(BUTTON_UP_PORT, BUTTON_UP_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"UP    ");		
//	}
//	if(!buttonPress(BUTTON_LEFT_PORT, BUTTON_LEFT_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"LEFT  ");		
//	}
//	if(!buttonPress(BUTTON_RIGHT_PORT, BUTTON_RIGHT_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"RIGHT ");		
//	}
//	if(!buttonPress(BUTTON_OK_PORT, BUTTON_OK_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"OK    ");		
//	}
//	if(!buttonPress(BUTTON_UNUSE_PORT, BUTTON_UNUSE_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"UNUSE ");		
//	}
//	if(!buttonPress(BUTTON_PROG_PORT, BUTTON_PROG_PIN, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"PROG  ");		
//	}
	
	if(!buttonPress(BT0_GPIO_Port, BT0_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"00");		
	}
	if(!buttonPress(BT1_GPIO_Port, BT1_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"01");		
	}
	if(!buttonPress(BT2_GPIO_Port, BT2_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"02");		
	}
	if(!buttonPress(BT3_GPIO_Port, BT3_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"03");		
	}
	if(!buttonPress(BT4_GPIO_Port, BT4_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"04");		
	}
	if(!buttonPress(BT5_GPIO_Port, BT5_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"05");		
	}
	if(!buttonPress(BT6_GPIO_Port, BT6_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"06");		
	}
	if(!buttonPress(BT7_GPIO_Port, BT7_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"07");		
	}
	if(!buttonPress(BT8_GPIO_Port, BT8_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"08");		
	}
	if(!buttonPress(BT9_GPIO_Port, BT9_Pin, 100)){
		LCD_Clear();
		LCD_Putsxy(0,0,"09");		
	}
//	if(!buttonPress(BT10_GPIO_Port, BT10_Pin, 100)){
//		LCD_Clear();
//		LCD_Putsxy(0,0,"10");		
//	}
}